---
layout:     post
title:      Announcing DiscoW!
author:     Bodong Chen
tags: 		DiscoW project
subtitle:   Announcing a newly funded NSF project that aims to devise a new science learning environment.
category:  DiscoW
visualworkflow: true
---

Dr. Bodong Chen was awarded [an NSF CRII/Cyberlearning research grant](https://www.nsf.gov/awardsearch/showAward?AWD_ID=1657009) to design a new environment to bring school science into closer alignment with real-world scientific discourse.

WE ARE HIRING! If you have an interest in learning technologies and have skills in Javascript development, please get in touch with [Dr. Chen](mailto:chenbd@umn.edu)!

An abstract of the upcoming project is posted below:
